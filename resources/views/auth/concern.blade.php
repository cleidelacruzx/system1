        ...
        <td>
            ...
            <tbody><tr>
                <td>
                    ...
                    <form>                    
                    <i class="fa fa-calendar icon"></i><input type="date" id="theDate"><br>
                      <script>
                        var date = new Date();
                    ...
                    <i class="fa fa-puzzle-piece icon"></i><input type="text" name="Problem" placeholder="Enter Problem" required=""><br>
                    <i class="fa fa-puzzle-piece icon"></i><input type="text" name="Problem" placeholder="Before the problem" required=""><br>
                    ...
                    <i class="fa fa-envelope icon"></i><input type="text" name="Email" placeholder="Email Address" required=""><br>
                    <table class="ticketnumber">
                      <tr>
                        <th class="ticket">Ticket Number:</th>
                    ...
                    <br>
                    <input name="accept" type="submit" value="Submit" href="#">
                    </form>
                </br>
                </div>
